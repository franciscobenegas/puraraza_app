...
import { TiposRazaList } from "../../../components/Configuracion/TiposRaza";

export function TipoRazaScreen() {
  ...
  const goToAddRegistro = () => {
    navigation.navigate("AddEditTipoRaza");
  };
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {!tiposRaza ? (
        ...
        <TiposRazaList tiposRaza={tiposRaza} onReload={onReload} />
      )}
    </ScrollView>
  );
}
